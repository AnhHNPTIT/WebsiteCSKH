                ...
                <div class="row">
                        ...
                        <div class="category-products">
                            <div class="toolbar-top">
                                <div class="toolbar">
                                    <div class="sorter">
                                        @if(isset($title))
                                            <p class="view-mode" style="color : #f27227; font-weight : 500; border : 1px solid #f27227; margin-left : 20px;">
                                                {{$title}}
                                            </p>
                                        @endif
                                                        ...
                                                        <div class="f-fix">
                                                            ...
                                                            <div class="price-box">
                                                                ...
                                                                <p class="special-price">
                                                                    <span class="price" content="60" id="product-price-182-emprice-e28d8be0787e9d8ae65c6afe74f8df0a" style="color: #f27227;">
                                                    ...
                                                    <div class="product-shop">
                                                        <div class="f-fix">
                                                            ...
                                                            <div class="price-box">
                                                                ...
                                                                @endif
                                                                <p class="special-price">
                                                                    <span class="price" content="60" id="product-price-182-emprice-e28d8be0787e9d8ae65c6afe74f8df0a" style="color: #f27227; padding-top:10px;">
                                                                        {{number_format($item->price_sale*1000 ,0 ,'.' ,'.')}} VND
                                                                    </span>
                                                                </p>
                                                            </div>
                    ...
                    <div class="col-sm-6 col-sm-pull-18 em-col-left em-sidebar">
                        <div id="menuleftText" class="all_categories">
                                    ...
                                    <div class="megamenu-wrapper wrapper-5_4607">
                                        <div class="em_nav" id="toogle_menu_5_4607">
                                            <ul class="vnav em-menu-icon effect-menu em-menu-long">
                                                ...
                                                <li class="menu-item-link menu-item-depth-0 fa fa-medkit menu-item-parent">
                                                                    ...
                                                                    <ul class="menu-container">
                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                            <ul class="menu-container" style="">
                                                                                @if(isset($menu_pathologies))
                                                                                    @foreach($menu_pathologies as $value)
                                                                                        <li class="menu-item-link menu-item-depth-1 first"> 
                                                                                            <a class="em-menu-link" href="{{ url('/danh-muc-san-pham/thuoc/'.$value->slug) }}">
                                                                                ...
                                                                                @endif
                                                                                <li class="menu-item-link menu-item-depth-1 first"> 
                                                                                    <a href="{{ url('/danh-muc-san-pham/thuoc') }}" style="font-size : 16px;">
                                                                                        <span>Xem thêm...</span> 
                                                                                    </a>
                                                                                </li>
                                                                            </ul><!-- /.menu-container -->
                                                                        ...
                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                            ...
                                                                            <div class="padding-top20">
                                                                                <ul class="em-catalog-navigation vertical">
                                                                                    @if(isset($menu_healthfoods_asc))
                                                                                        @foreach($menu_healthfoods_asc as $i => $item)
                                                                                            @if(0 <= $i && $i < 8)
                                                                                                <li class="level0 nav-1">
                                                                                                    @if(strlen($item->name) < 30)
                                                                                                        <a href="{{url('san-pham/'.$item->slug)}}"> <span>{{$item->name}}</span> </a>
                                                                                                    @else
                                                                                    ...
                                                                                    @if(isset($menu_healthfoods_asc))
                                                                                        ...
                                                                                        @endforeach
                                                                                                <li class="level0 nav-2">
                                                                                                    <a href="{{ url('/cua-hang/thuc-pham-chuc-nang') }}"> <span>Xêm thêm...</span> </a>
                                                                                                </li>
                                                                                    @endif
                                                                                </ul>
                                                                            </div>
                                                ...
                                                <li class="menu-item-link menu-item-depth-0 fa fa-shopping-cart menu-item-parent">
                                                            ...
                                                            <ul class="menu-container">
                                                                <li class="menu-item-vbox menu-item-depth-2 col-sm-6 menu-item-parent" style="">
                                                                    <ul class="menu-container">
                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                            <ul class="list-text">
                                                                                @if(isset($menu_consumergoods_asc))
                                                                                    @foreach($menu_consumergoods_asc as $i => $item)
                                                                                        @if(0 <= $i && $i < 4)
                                                                                            ...
                                                                                            @else
                                                                                                <li>
                                                                                                    <a href="{{url('san-pham/'.$item->slug)}}"> 
                                                                                                        <span>{{substr($item->name, 0, 24)}}...</span> 
                                                                                                    </a>
                                                                                                </li>
                                                                                            @endif
                                                                                        @endif
                                                                                ...
                                                                                @if(isset($menu_consumergoods_asc))
                                                                                    @foreach($menu_consumergoods_asc as $i => $item)
                                                                                        @if(12 <= $i)
                                                                                            ...
                                                                                            @else
                                                                                                <li>
                                                                                                    <a href="{{url('/cua-hang/hang-tieu-dung')}}"> 
                                                                                                        <span>{{substr($item->name, 0, 24)}}...</span> 
                                                                                                    </a>
                                                                                                </li>
                                                                                            @endif
                                                ...
                                                <li class="menu-item-link menu-item-depth-0 fa fa-user-md menu-item-parent">
                                                                            ...
                                                                            <ul class="menu-container">
                                                                                <li class="menu-item-vbox menu-item-depth-2 col-sm-6 menu-item-parent" style="">
                                                                                    <ul class="menu-container">
                                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                                            <ul class="list-text">
                                                                                                @if(isset($menu_medicalequipments))
                                                                                                    @foreach($menu_medicalequipments as $i => $item)
                                                                                                        @if(0 <= $i && $i < 4)
                                                                                                        <li>
                                                                                                            <a href="{{url('san-pham/'.$item->slug)}}"> 
                                                                                                                <span>{{$item->name}}</span> 
                                                                                        ...
                                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                                            <ul class="list-text">
                                                                                                @if(isset($menu_medicalequipments))
                                                                                                    ...
                                                                                                    @endforeach
                                                                                                                <li>
                                                                                                                    <a href="{{url('/cua-hang/thiet-bi-y-te')}}"> 
                                                                                                                        <span>Xem thêm...</span> 
                                                                                                                    </a>
                                                                                                                </li>
                                                                                                @endif
                            ...
                            @if(isset($title) && $title == "Thực phẩm chức năng")
                            <div class="em-block-title" style="text-align : center;"> 
                                <strong><span style="color : #fff;">Nhóm hỗ trợ điều trị</span></strong>
                            </div>
                            <div class="block-content" id="brand-scroll" style="padding-bottom : 20px; margin-bottom : 10px;">
                                <ul id="narrow-by-list">
                                    <form method="get" action="" class="form-filllter">
                                        @if(isset($treatments))
                                            @foreach($treatments as $value)
                                                <li style="line-height : 30px; margin-top : 10px;"> 
                                                <label class="check-sty" style="line-height : 30px;">
                                                    <input type="checkbox" name="utility" value="{{$value->slug}}" @if(isset($check_utilities[$value->id])) {{'checked'}} @endif >
                                                    <span class="checkmark"></span>
                                                        {{$value->name}}
                                                    </label>
                                                </li>
                            ...
                            @else
                            <div class="em-block-title" style="text-align : center;"> 
                                <strong><span style="color : #fff;">Nhóm công dụng</span></strong>
                            </div>
                            <div class="block-content" id="brand-scroll" style="padding-bottom : 20px; margin-bottom : 10px;">
                                <ul id="narrow-by-list">
                                    <form method="get" action="" class="form-filllter">
...
<script>
  $(document).ready(function(){
      $('#form-order').change(function(){
        ...
        if(utilities_slug.length > 0){
            url += '&utility=';
            url += utilities_slug.join(',');
        }
