			...
			<div class="box">
				...
				<div class="box-body">
					<div style="margin-bottom: 30px;">
						@if($title != 'Danh mục Dịch vụ')
						<a href="/admin/new/category" data-toggle="modal" class="btn btn-success btn-add">Thêm Chủ đề</a>
						@endif
					</div>
					<table id="list-categories" class="table table-bordered table-striped" style="margin-top : 10px;">
						...
						<tbody>
							...
							<tr>
								...
								<!-- <td class="col-sm-2">
									<img style="width: 100%; height: 100px;" src="{{url('images/categories/'.$value->thumbnail)}}" alt="">
								</td> -->
								...
								<td class="col-sm-2">
									...
									@if(!in_array($value->slug, array('internet', 'dich-vu-truyen-hinh', 'dich-vu-camera')))
