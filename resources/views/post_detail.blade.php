                    ...
                    <div class="col-sm-18 em-col-main">
                        <div class="em_post-item">
                            ...
                            <div class="post-footer"> 
                                <span class="post-by">Đăng bởi : <span>{{$post->author}}</span></span>
                            ...
                            <div class="" style="text-align : justify; font-weight: bold;">
                                <p>
                                    {!!$post->description!!}
                                </p>
                            </div>
                                        ...
                                        @foreach($recent_posts as $post)
                                            <li class="item">
                                                <a href="{{ url('/tin-tuc/'.$post->slug) }}"> 
                                                    <img alt="{{ url('/tin-tuc/'.$post->slug) }}" src="{{asset('/images/'.$post->thumbnail)}}" /> 
                                                </a> 
                                                <a class="post-title em-blog-title" href="{{ url('/tin-tuc/'.$post->slug) }}" style="text-transform: capitalize !important;">
                                                    {{$post->title}}
                                                </a>
                                                <p class="intro">
                        ...
                        <div class="block em_block-tag-cloud em-line-01">
                            ...
                            <div class="block-content">
                                <ul>
                                    @if(isset($tags))
                                        @foreach($tags as $tag)
                                            <li class="item"><a href="{{ url('/tag/'.$tag->slug) }}" style="font-size:122px; color: #f27227;">{{$tag->name}}</a>
                                            </li>
                                        @endforeach
                                    @endif
                                </ul>
