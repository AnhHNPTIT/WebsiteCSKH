                ...
                <div class="hidden-xs em-header-style08">
                    <div class="em-header-top">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-24">
                                    <div class="f-left" style="padding-top: 14px;">
                                        <div class="f-left">
                            ...
                            <div class="row">
                                <div class="col-sm-24">
                                    <div class="em-logo f-left" style="width : 85px; height : 75px; box-sizing : border-box;">
                                        <a href="/" class="logo" style="margin: 12px 0;">
                                                    ...
                                                    <div class="em_nav" id="toogle_menu_4_7164">
                                                        <ul class="hnav em_hoz_menu effect-menu">
                                                            ...
                                                            <li class="menu-item-link menu-item-depth-0 hidden-sm hidden-md menu-item-parent">
                                                                <a class="em-menu-link" href="{{ url('/goc-tin-tuc') }}"> <span> Tin tức </span> </a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8 text-center" style="margin-bottom : 20px;">
                                                ...
                                                <p style="color: #ffffff;">
                                                    <a href="{{ url('/') }}">
                                                        Thành lập: 31/ 01/1997
                                                    </a>
                                                </p>
                                                <p style="color: #ffffff;">
                                                    Co-Founder: Hoàng Nam Tiến
                                                </p>
                                                <p style="color: #ffffff;">
                                                    Địa chỉ: 17, Duy Tân, P. Dịch Vọng Hậu, Q. Cầu Giấy, TP. Hà Nội
                                                </p>
                                                <br>
                                                <!-- <p style="color: #ffffff;">
                                                ...
                                                <p style="color: #ffffff;">
                                                    Trụ sở: 48 Vạn Bảo, Ngọc Khánh, Quận Ba Đình, TP Hà Nội, Việt Nam
                                                </p> -->
                                            </div><!-- /.col-sm-4 -->
