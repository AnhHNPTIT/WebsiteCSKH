...
<head>
    ...
    })(window,document,'script','dataLayer','GTM-5RLZGHQ');</script>
    ...
    <meta name="description" content="Đến với mọi cửa hàng của Mạng FPT, bạn đều được trải nghiệm và mua sắm những sản phẩm chất lượng cao, uy tín hàng đầu trên thị trường chăm sóc sức khỏe">
...
<body class="contacts-index-index ">
        ...
        <div class="page one-column">
            <div class="em-wrapper-header">
                ...
                <div id="em-mheader-top" class="row" style="background : #fff; margin-top: -10px;">
                    ...
                    <div class="em-logo col-xs-10" style="margin-right: 0px;">
                        <a href="tel:0899766566">    
                            ...
                            <span style="font-weight:bold; font-size:14px;"><span style="color:#f27227;">1900 6600</span></span> 
                        </a>
                    </div>
                </div>
                                                    ...
                                                    <div class="em_nav" id="toogle_menu_7_5505">
                                                        <ul class="hnav em_menu_mobile">
                                                            <li class="menu-item-link menu-item-depth-0 dd-menu-link fa fa-list">
                                                                <a class="em-menu-link" href="{{ url('/dich-vu-internet/fpt-lap-mang-wifi-gia-re-mien-phi-lap-dat-1665809156') }}"> <span> Dịch vụ Internet </span> </a>
                                                            </li>

                                                            <li class="menu-item-link menu-item-depth-0 dd-menu-link fa fa-user-md">
                                                                <a class="em-menu-link" href="{{ url('/dich-vu-truyen-hinh/fpt-shop-lap-mang-wifi-gia-re-mien-phi-lap-dat-1665808523') }}"> <span> Dịch vụ Truyền hình </span> </a>
                                                            </li>

                                                            <li class="menu-item-link menu-item-depth-0 dd-menu-link fa fa-address-book-o">
                                                                <a class="em-menu-link" href="{{ url('/dich-vu-camera/fpt-shop-lap-mang-wifi-gia-re-mien-phi-lap-dat-1665808522') }}"> <span> Dịch vụ Camera </span> </a>
                                                            </li>

                                                            <li class="menu-item-link menu-item-depth-0 dd-menu-link fa fa-address-book-o">
                                                                <a class="em-menu-link" href="{{ url('/dang-ki-dich-vu') }}"> <span style="text-transform: uppercase;"> Đăng kí dịch vụ</span> </a>
                                                            </li>

                                                            <li class="menu-item-link menu-item-depth-0 dd-menu-link fa fa-address-book-o">
                                                                <a class="em-menu-link" href="{{ url('/goc-tin-tuc') }}"> <span style="text-transform: uppercase;"> Tin tức</span> </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                ...
                <div class="hidden-xs em-header-style08">
                                    ...
                                    <div class="f-left" style="padding: 14px 20px;">
                                        <!-- <div class="f-left">
                                            <ul style="margin-bottom: 0px !important;">
                                                <li class=""> 
                                                    <a href="{{url('/')}}">    
                                                        <img src="{{asset('/images/icons/logo.png')}}" alt="" style="height: 115px; width: 320px; margin-bottom: -90px; margin-top: -30px; padding-left: -8px; margin-left: -35px;"> 
                                                    </a>
                                                </li>
                                            </ul>
                                        </div> -->
                                        <div id="hotline" class="f-left">
                                            <ul style="margin-bottom: 0px !important;">
                                                <li class=""> 
                                                    <a href="tel:0899766566" style="color:#f27227;">    
                                                        <span style="font-weight:bold; font-size:14px;"><span>Hotline:</span> <span style="color:#f27227;">1900 6600</span></span> 
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                                            ...
                                                            <form id="search_mini_form" method="get" action="{{ url('/search') }}">
                                                                <div class="form-search no_cate_search">
                                                                    <div class="text-search">
                                                                        ...
                                                                        <input id="search" type="text" name="parameter" value="" class="input-text" maxlength="128" placeholder="Nhập từ khóa tìm kiếm ..." onkeyup="searching()"/>
                    ...
                    <div class="em-header-bottom em-fixed-top" style="background : #f27227;">
                            ...
                            <div class="row">
                                <div class="col-sm-24">
                                    ...
                                    <div class="em-logo-sticky f-left">
                                        <a href="/" class="logo">
                                        <img class="retina-img" src="{{asset('/images/icons/logo.png')}}" style="width : 162px; height : 52px;"/>
                                        </a>
                                    </div>
                                                    ...
                                                    <div class="em-container-js-search" style="display: none;">
                                                        <form id="search_mini_form_fixed_top" method="get" action="{{ url('/search') }}">
                                                            <div class="form-search">
                                                                ...
                                                                <input id="search-fixed-top" type="text" name="parameter" value="" class="input-text" maxlength="128" placeholder="Nhập từ khóa tìm kiếm..." onkeyup="miniSearching()"/>
                                                                <button type="submit" title="Search" class="button">
                                                    ...
                                                    <div class="em_nav" id="toogle_menu_4_7164">
                                                        <ul class="hnav em_hoz_menu effect-menu">
                                                            <li class="menu-item-link menu-item-depth-0  menu-item-parent">
                                                                <a class="em-menu-link" href="{{ url('/tin-tuc/fpt-lap-mang-wifi-gia-re-mien-phi-lap-dat-1665809156') }}"> <span> Mua thuốc theo đơn </span> </a>
                                                            </li><!-- /.menu-item-link -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8 text-center" style="margin-bottom : 20px;">
                                                <div class="em-block-title">
                                                    <p class="h4 em-text-upercase"><span>FPT Telecom</span>
                                                    </p>
                                                </div>
                                                <!-- <p style="color: #ffffff;">
                                                    <a href="{{ url('/') }}">
                                                        Hộ kinh doanh <span>FPT Telecom</span>
                                                    </a>
                                                </p>
                                                <p style="color: #ffffff;">
                                                     Giấy phép ĐKKD số: 01F8012126 Cấp ngày 25/6/2021
                                                </p>
                                                <p style="color: #ffffff;">
                                                    Dược sĩ phụ trách CM: Trần Thị Tuyết Nhung
                                                </p>
                                                <br>
                                                <p style="color: #ffffff;">
                                                ...
                                                <ul id="collapse02" class="em-links em-block-content block-info">
                                                    <li class="em-links-item">
                                                        <a href="tel:0899766566">    
                                                            ...
                                                            <span style="font-weight:bold; font-size:14px;"><span>Hotline:</span> <span>1900 6600</span></span> 
                                                        </a>
                                                    </li>
                                                    <!-- <style>
                            ...
                            <div class="row">
                                <div class="col-sm-24">
                                    <div class="em-footer-address"> 
                                        <address class="f-left">&copy; Bản quyền thuộc về Mạng FPT</address>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div id="fb-root"></div>
      ...
      <div class="fb-customerchat"
        ...
        page_id="112898516810168"
        theme_color="#0000FF"
        logged_in_greeting="Xin chào, Mạng FPT có thể giúp gì cho bạn?"
        logged_out_greeting="Xin chào, Mạng FPT có thể giúp gì cho bạn?">
      </div>
</body>
