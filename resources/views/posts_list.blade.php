                                ...
                                @foreach($posts as $post)
                                    <div class="em_post-item">
                                        ...
                                        <div class="post-image col-sm-8">
                                            <a href="{{ url('/tin-tuc/'.$post->slug) }}"> 
                                                <img class="img-responsive" alt="{{$post->title}}" src="{{asset('/images/'.$post->thumbnail)}}" style="height: 170px;"/> 
                                            </a>
                                        </div>
                            ...
                            <div class="block-content">
                                <ul>
                                    @if(isset($tags))
                                        @foreach($tags as $tag)
                                            <li class="item">
                                                <a href="{{ url('/tag/'.$tag->slug) }}" style="font-size:122px; color: #f27227;">{{$tag->name}}</a>
                                            </li>
                                        @endforeach
                                    @endif
                                </ul>
